 ...
 */
function FpsMeter(initialScore, scoreLabel, targetFramesPerSecond) {
...
//  this.infoPanel.innerHTML = "<div class='meter' id='score'></div><div class='label'id='scoreLabel'></div><div class='data' id='windowSize'></div><div class='label' id='windowSizeLabel'></div><div class='data' id='browserLabel'>" + this.browserName +" "+this.browserVersion +"<div id='settings'></div>";
	this.infoPanel.innerHTML = "<div class='meter' id='score'></div><div class='label'id='scoreLabel'></div><div class='data' id='windowSize'></div><div class='label' id='windowSizeLabel'></div><div class='data' id='browserLabel'><div id='settings'></div>";*/
    ...
    */
    ...
    this.targetFPS = targetFramesPerSecond;
...
FpsMeter.prototype.currentSecond = new Date();					
FpsMeter.prototype.framesThisPeriod = 0;
FpsMeter.prototype.timeDeltaSinceLastFrame = 0;
FpsMeter.prototype.timeFpsDisplayLastChanged = 0;
FpsMeter.prototype.fpsDisplayUpdateFrequency = 2000;
...
FpsMeter.prototype.targetFPS = 60;
