...
function Tile() {
    ...
    */
    ...
    /* Removing shadows for mobile GPUs
    // Set the size of the tile.
    ...
    */
    ...
    this.Draw = function () {
        ...
        if (this.animating == true && this.initialDelay == 0) {
            ...
            // this.DrawShadow();  Remove shadow for mobile GPUs
            ...
            /* Remove shadows for mobile GPUs
