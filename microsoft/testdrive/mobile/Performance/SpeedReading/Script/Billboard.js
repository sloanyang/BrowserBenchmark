...
function Billboard() {
    ...
    this.paddingTop = 15;
    this.paddingEdge = 0;
    this.paddingMinimumEdge = 10;
    this.paddingMinimumBottom = 15;
    ...
    this.SetTileSizes = function () {
        ...
        this.startButtonLeft = (7 * (this.currentTileWidth + this.currentHorizontalTilePadding)) + this.paddingEdge + (this.currentTileWidth * 0.20);
        this.startButtonTop = (3 * (this.currentTileHeight + this.currentVerticalTilePadding)) + this.paddingTop + (this.currentTileHeight * 0.20);

        this.startButtonWidth = this.currentTileWidth / this.defaultTileWidth * 130;
        this.startButtonHeight = this.currentTileWidth / this.defaultTileWidth * 70;
