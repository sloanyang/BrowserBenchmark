...
var _om_gbls = {
	...
	modClick : function(obj,type,cat,text,dest,evts) {	
		...
		s.prop3 = cat + ": " + text;
		if (cat=="social") s.events = "event2";
		if (cat=="preview") s.events = "event3";
		if (evts.indexOf("events")>-1) s.apl(s.events,evts,",",2);
		if(type==0) {
...
s.linkInternalFilters="javascript:,ie.microsoft.com/testdrive";
s.linkLeaveQueryString=true;  // typically false
...
/************* DO NOT ALTER ANYTHING BELOW THIS LINE! S_CODE H20.3 **************/
...
//     function a(t, e, f, c) {        
//         if (typeof t.addEventListener != "undefined") {
//             t.addEventListener(e, f, c);
//         } else {
...
//     function r() {
//         var e = document.getElementById('DemoReturnButton');
