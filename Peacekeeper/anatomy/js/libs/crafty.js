	...
	*/
	...
	timer: {
      ...
      nextGameTick = (new Date).getTime();
          ...
          if (Crafty.timer.lastFrameTime > 0)
          { 
            Crafty.timer.fps = 1 / ((currentFrameTime - Crafty.timer.lastFrameTime) / 1000);
          }
          Crafty.timer.lastFrameTime = currentFrameTime;
